...
```{r}
knitr::include_graphics("ARIMA_HJ/arima/sarima/arfima_acf.png")
```
...
```{r}
knitr::include_graphics("ARIMA_HJ/arima/arfima/sarima_residuals.png")
```

```{r}
knitr::include_graphics("ARIMA_HJ/.png")
```
